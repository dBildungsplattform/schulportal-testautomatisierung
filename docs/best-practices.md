...
Jeder Test soll ein `afterEach` mit Logout enthalten. Das Löschen von Testdaten im `afterEach` ist nicht nötig, da das Global Teardown diese Aufgabe übernimmt.
