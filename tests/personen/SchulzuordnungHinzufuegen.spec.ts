...
test.describe(`Testfälle für Schulzuordnung hinzufügen: ENV: ${process.env.ENV} URL: ${process.env.FRONTEND_URL}`, () => {
  ...
  test('Unbefristete Schulzuordnung einem Lehrer durch einen Landesadmin hinzufügen', async ({
    page,
  }: PlaywrightTestArgs) => {
