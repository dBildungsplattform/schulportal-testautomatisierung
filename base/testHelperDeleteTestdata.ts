...
export async function deletePersonById(personId, page) {
...
export async function deleteRolleById(roleId, page) {
...
export async function deleteRolleByName(roleName, page) {
...
export async function deleteKlasseByName(klassenName, page) {
